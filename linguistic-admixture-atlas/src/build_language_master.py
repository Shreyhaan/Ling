...
def read_glottolog_geo() -> tuple[list[dict[str, str]], dict[str, str]]:
    ...
    detected = {
        ...
        "isocodes": optional_column(columns, ["isocodes", "Isocodes", "iso639P3code", "ISO639P3code", "iso", "ISO", "iso_code"]),
    }
...
def read_glottolog_languoid_metadata() -> dict[str, dict[str, str]]:
    ...
    isocodes_col = optional_column(columns, ["isocodes", "Isocodes", "iso639P3code", "ISO639P3code", "iso", "ISO", "iso_code"])
